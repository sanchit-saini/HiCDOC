test_that("filterWeakPositions behaves as expected", {
    ...
    expect_message(object <- filterWeakPositions(object), "Removed 0 positions")
    ...
    expect_message(object <- filterWeakPositions(object, threshold = 50), "Removed 3 positions")
    expect_equal(nrow(object@interactions), 84466)
    expect_identical(object@weakBins, list("17" = c(124L, 125L, 126L), "18" = NULL))
