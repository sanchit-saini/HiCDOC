test_that("reduceHiCDOCDataSet works if select chromosome, dropLevels", {
    ...
    expect_warning(object <- reduceHiCDOCDataSet(object, chromosomes=c("17")), 
    ...
    expect_identical(levels(object@diagonalRatios$chromosome), "17")
    ...
    expect_identical(levels(object@diagonalRatios$condition), c("1", "2"))
    ...
    expect_identical(levels(object@diagonalRatios$replicate), c("1", "2", "3"))
...
test_that("reduceHiCDOCDataSet works if select chromosome, keep levels", {
    ...
    expect_identical(levels(object@diagonalRatios$chromosome), c("17", "18"))
...
test_that("reduceHiCDOCDataSet works if select conditions, dropLevels", {
    ...
    expect_identical(levels(object@diagonalRatios$condition), c("1"))
...
test_that("reduceHiCDOCDataSet works if select replicate, dropLevels", {
    ...
    expect_identical(levels(object@diagonalRatios$replicate), c("1"))
